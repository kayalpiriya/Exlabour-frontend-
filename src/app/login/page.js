                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-12 pr-4 py-3.5 rounded-2xl border bg-white/5 text-white placeholder:text-slate-400 outline-none focus:ring-2 transition focus:bg-white/10 ${errors.email ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:ring-cyan-400/50 focus:border-cyan-300'
                                            }`}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-12 pr-4 py-3.5 rounded-2xl border bg-white/5 text-white placeholder:text-slate-400 outline-none focus:ring-2 transition focus:bg-white/10 ${errors.password ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:ring-cyan-400/50 focus:border-cyan-300'
                                            }`}
                                        onChange={handleChange}
                                    />
                                </div>
