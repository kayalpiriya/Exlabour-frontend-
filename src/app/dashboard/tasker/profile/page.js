            ...
            <div className="bg-white rounded-[32px] shadow-[0_8px_30px_rgba(15,23,42,0.04)] border border-slate-100 overflow-hidden">
                ...
                <div className="px-6 sm:px-10 pb-10 relative">
                    ...
                    <div className="pt-20 sm:pt-24 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                        ...
                        {/* Status Badge */}
                        <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider border shadow-sm ${user?.verificationStatus === 'verified' ? 'bg-emerald-50 text-emerald-600 border-emerald-200' :
                                user?.verificationStatus === 'pending' ? 'bg-amber-50 text-amber-600 border-amber-200' :
                                    'bg-rose-50 text-rose-600 border-rose-200'
                            }`}>
                            <span className={`w-2 h-2 rounded-full ${user?.verificationStatus === 'verified' ? 'bg-emerald-500' :
