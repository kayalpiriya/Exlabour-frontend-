                    ...
                    {filteredUsers.map((user) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                {/* Modern Status Badge */}
                                <div className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider border ${user.verificationStatus === 'verified' ? 'bg-emerald-50 text-emerald-600 border-emerald-200' :
